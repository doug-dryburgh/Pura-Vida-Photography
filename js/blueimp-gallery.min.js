    ...
    return t.extend(e.prototype, {
        ...
        , ontouchend: function (t) {
            ...
            var e, i, s, n, o, r = this.index
                ...
                , d = h && Math.abs(this.touchDelta.x) > 20 || Math.abs(this.touchDelta.x) > a / 2
            ...
            this.options.continuous && (c = !1), e = this.touchDelta.x < 0 ? -1 : 1, this.isScrolling ? u ? this.close() : this.translateY(r, 0, l) : d && !c ? (i = r + e, s = r - e, n = a * e, o = -a * e, this.options.continuous ? (this.move(this.circle(i), n, 0), this.move(this.circle(r - 2 * e), o, 0)) : i >= 0 && i < this.num && this.move(i, n, 0), this.move(r, this.positions[r] + n, l), this.move(this.circle(s), this.positions[this.circle(s)] + n, l), r = this.circle(s), this.onslide(r)) : this.options.continuous ? (this.move(this.circle(r - 1), -a, l), this.move(r, 0, l), this.move(this.circle(r + 1), a, l)) : (r && this.move(r - 1, -a, l), this.move(r, 0, l), r < this.num - 1 && this.move(r + 1, a, l))
        }
        ...
        , imageFactory: function (e, i) {
            function s(e) {
                if (!n) {
                    ...
                    n = !0, t(a).off("load error", s), d && "load" === e.type && (o.style.background = 'url("' + h + '") center no-repeat', o.style.backgroundSize = d), i(e)
                }
            }
            var n, o, r, l = this
            ...
            return "string" != typeof h && (h = this.getItemProperty(e, this.options.urlProperty), r = this.getItemProperty(e, this.options.titleProperty)), d === !0 && (d = "contain"), d = this.support.backgroundSize && this.support.backgroundSize[d] && d, d ? o = this.elementPrototype.cloneNode(!1) : (o = a, a.draggable = !1), r && (o.title = r), t(a).on("load error", s), a.src = h, o
        }
    ...
    return t.extend(e.prototype, {
        ...
        , videoFactory: function (e, i, s) {
            ...
            return v && (m.poster = v, n = this.imagePrototype.cloneNode(!1), t(n).addClass(d.toggleClass), n.src = v, n.draggable = !1, c.appendChild(n)), r = document.createElement("a"), r.setAttribute("target", "_blank"), s || r.setAttribute("download", g), r.href = y, m.src && (m.controls = !0, (s || t(m)).on("error", function () {
                ...
                m.seeking || (l = !1, u.removeClass(h.options.videoLoadingClass).removeClass(h.options.videoPlayingClass), a && h.container.addClass(h.options.controlsClass), delete h.playingVideo, h.interval && h.play())
            }).on("playing", function () {
                l = !1, u.removeClass(h.options.videoLoadingClass).addClass(h.options.videoPlayingClass), h.container.hasClass(h.options.controlsClass) ? (a = !0, h.container.removeClass(h.options.controlsClass)) : a = !1
            }).on("play", function () {
...
, function (t) {
    ...
    return t.extend(s.prototype, {
        ...
        , loadAPI: function () {
            ...
            for (var i, s, n = this, o = "//f.vimeocdn.com/js/froogaloop2.min.js", r = document.getElementsByTagName("script"), l = r.length; l;)
                if (l -= 1, r[l].src === o) {
                    i = r[l];
                    break
                }
